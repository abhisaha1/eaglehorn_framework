<?php
namespace Eaglehorn\worker\Zip;
...
class Zip
{
     ...
     *
     * @param String $data
     * @return bool|int $length bytes added or FALSE if the archive is finalized or there are no open stream.
     */
     ...
     * @return bool $success
     */
    function downloadZip($fileName, $contentType = "application/zip")
    {
        if (!$this->isFinalized) {
            $this->finalize();
        }
     ...
     *
     * @return int $size Size of the archive
     */
